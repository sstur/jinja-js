...
(function(definition) {
  ...
  var getRuntime = function(data, opts) {
  ...
  var runtimeCode = getRuntime.toString();
  //super-trivial comment removal
  ...
  jinja.compile = function(markup, opts) {
    ...
    var code = [];
    code.push('function(get, set, push, pop, write, filter, each, block, render) {');
    code.push.apply(code, parser.parse(markup));
    code.push('return render();');
    code.push('}');
    code = code.join('\n');
    if (opts.runtime === false) {
      var fn = new Function('data', 'options', 'return (' + code + ').apply(null, getRuntime(data, options));');
    } else {
      fn = new Function('data', 'options', 'return (' + code + ').apply(null, (' + runtimeCode + ')(data, options));');
    }
    return {render: fn};
  };
